...
class AnalysisRequest(VariableSchemaSupport, BrowserDefaultMixin, BaseFolder):
    ...
    archetype_name = 'AnalysisRequest'
    schema = schema
    allowed_content_types = ('Analysis',)
    content_icon = 'ar.png'
    ...
    actions = (
        {'id': 'edit',
         'name': 'Edit',
         'action': 'string:${object_url}/analysisrequest_edit_form',
         'permissions': (ModifyPortalContent,),
        },
        {'id': 'analyses',
         'name': 'Manage results',
         'action': 'string:${object_url}/analysisrequest_analyses',
         'permissions': (ManageAnalysisRequest,),
        },
        {'id': 'analyses_not_requested',
         'name': 'Results not requested',
         'action': 'string:${object_url}/analysisrequest_analyses_not_requested',
        ...
        {'id': 'arinvoice',
         'name': 'Invoice',
         'action': 'string:${object_url}/analysisrequest_invoice',
         'condition': 'python:here.hasBeenInvoiced() and not here.getInvoiceExclude()',
         'permissions': (View,),
        },
        {'id': 'proforma_arinvoice',
         'name': 'Proforma Invoice',
         'action': 'string:${object_url}/analysisrequest_invoice',
         'condition': 'python:not here.hasBeenInvoiced() and not here.getInvoiceExclude()',
         'permissions': (View,),
        },
        ...
        {'id': 'issue_invoice',
         'name': 'Invoice',
         'action': 'string:issueInvoice:method',
         'permissions': (ManageInvoices,),
         'condition': 'python:not here.getInvoice() and not here.getInvoiceExclude()',
         'category': 'folder_buttons',
        },
        {'id': 'print_invoice',
         'name': 'Print Invoice',
         'action': 'string:printInvoice:method',
         'permissions': (View,),
         'condition': 'python:here.getInvoice()',
         'category': 'folder_buttons',
        },
        # document actions
        {'id': 'sticker_lrg',
         'name': 'Large Sticker',
         'action': 'string:${object_url}/analysisrequest_sticker',
         'permissions': (View,),
         'category': 'document_actions',
        },
        {'id': 'sticker_sml',
         'name': 'Small Sticker',
         'action': 'string:${object_url}/analysisrequest_sticker_small',
         'permissions': (View,),
         'category': 'document_actions',
        },
    )
