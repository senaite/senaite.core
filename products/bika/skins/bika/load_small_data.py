...
for title in ('email', 'fax', 'file', 'print'):
...
sampletypes = (
    ('Mielies', 'Mielie kernels', False),
    ('Jam', 'Pots of jam', False),
    ('Dog Food', 'Dog food wet sample', True),
    ('Staff', 'People stuff', False),
    ('Surface', 'Surface swab', False),
    )
...
# 
client_list = (
('440', ' Happy Hills Feeds', '1', 'happyhills@scapp.co.za', '021 3404220', '0213404220', 'Rita', 'Ndo', 'rita', 'gna@scapp.co.za', 'fax'),
('1624', ' Moorreesburg Canola', '0', 'mcan@scapp.co.za', '021 6151901', '0216153417', 'Fred', 'Terry', 'fred', 'vbay@scapp.co.za', 'email'),
('480', ' Porterville Co-op', '1', 'porterville@scapp.co.za', '021 3551730', '0213551731', 'Gile', 'Fransman', 'gile', 'nakkie@scapp.co.za', 'email'),
    )
...
for account_nr, name, member, email, tel, fax, cname, csurname, cusername, cemail, cpubl_pref in client_list:
    ...
    # Give labmanager an Owner local role on client
    pm = context.portal_membership
    pm.setLocalRoles( obj=client, member_ids=['labmanager01',],
        member_role='Owner')
...
templates = (
    ('Dry food standard', ({'pos': 1, 'type': 'b', 'sub': std_stocks[0]},
                       ...
                       {'pos': 4, 'type': 'a', 'sub': ''},
                       {'pos': 5, 'type': 'd', 'sub': '3'}),
      [service_objs['AcidInsolubleResidue'], service_objs['Ash']]),
    )
