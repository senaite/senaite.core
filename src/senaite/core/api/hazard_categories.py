...
"""High-level helpers for the GHS hazard category feature.

This module is the single entry point for everything that renders
hazard pictograms (sample title viewlet, edit-form widget, listing
columns, custom reports). The vocabulary in
``senaite.core.vocabularies.hazard_categories`` is the data layer;
this module produces URLs and view-model dicts on top of it.
"""
