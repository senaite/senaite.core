...
the the definitive id is set:
    ...
    >>> folder = senaite_setup.sample_containers
...
If we use `api.create`, the object returned is not temporary:
    ...
    >>> obj = api.create(senaite_setup.sample_containers, "SampleContainer", title="Another sample container")
...
It works for Dexterity types as well::
    ...
    >>> sample_containers = self.portal.setup.sample_containers
