...
from senaite.core.interfaces import ISetupDataSetList
from senaite.core.utils import getFromString
from senaite.core.utils import t
from senaite.core.utils import tmpID
from senaite.core.utils import to_unicode
from senaite.core.utils.analysis import create_analysis
...
class SetupDataSetList(SDL):
    ...
    def __call__(self):
        return SDL.__call__(self, projectname="senaite.core")
