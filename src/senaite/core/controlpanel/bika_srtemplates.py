...
from senaite.core.interfaces import ISamplingRoundTemplates
from senaite.core.permissions import AddSRTemplate
from senaite.core.utils import checkPermissions
...
class SamplingRoundTemplatesView(BikaListingView):
    ...
    def __init__(self, context, request):
        ...
        self.icon = self.portal_url + "/++resource++senaite.core.images/srtemplate_big.png"
