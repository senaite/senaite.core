...
from senaite.core.interfaces import IReflexRuleFolder
from senaite.core.permissions import ManageBika, AddReflexRule
...
class ReflexRuleFolderView(BikaListingView):
    ...
    def __init__(self, context, request):
        ...
        self.icon = self.portal_url +\
            "/++resource++senaite.core.images/reflexrule_big.png"
