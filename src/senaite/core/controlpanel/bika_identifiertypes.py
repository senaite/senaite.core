...
from senaite.core.interfaces import IIdentifierTypes
from senaite.core.permissions import AddIdentifierType
...
class IdentifierTypesView(BikaListingView):
    ...
    def __init__(self, context, request):
        ...
        self.icon = "{}/{}".format(
            self.portal_url,
            "++resource++senaite.core.images/identifiertype_big.png")
