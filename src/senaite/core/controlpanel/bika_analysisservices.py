...
from senaite.core.interfaces import IAnalysisServices
...
from senaite.core.validators import ServiceKeywordValidator
...
class AnalysisServicesView(BikaListingView):
    ...
    def __init__(self, context, request):
        ...
        self.icon = "{}/{}".format(
            self.portal_url,
            "/++resource++senaite.core.images/analysisservice_big.png"
        )
