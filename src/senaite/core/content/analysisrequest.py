...
from senaite.core import deprecated
from senaite.core import logger
from senaite.core.browser.fields import ARAnalysesField
from senaite.core.browser.fields import DateTimeField
from senaite.core.browser.fields import DurationField
...
from senaite.core.browser.widgets import DecimalWidget
from senaite.core.browser.widgets import PrioritySelectionWidget
from senaite.core.browser.widgets import ReferenceWidget
from senaite.core.browser.widgets import RejectionWidget
from senaite.core.browser.widgets import RemarksWidget
from senaite.core.browser.widgets import SelectionWidget as BikaSelectionWidget
from senaite.core.browser.widgets.durationwidget import DurationWidget
from senaite.core.catalog import CATALOG_ANALYSIS_LISTING
from senaite.core.catalog import CATALOG_ANALYSIS_REQUEST_LISTING
from senaite.core.config import PRIORITIES
...
from senaite.core.interfaces import IAnalysisRequestPartition
from senaite.core.interfaces import ICancellable
from senaite.core.interfaces import ISubmitted
...
from senaite.core.permissions import FieldEditSamplingRound
...
from senaite.core.utils import getUsers
from senaite.core.utils import tmpID
from senaite.core.utils import user_email
from senaite.core.utils import user_fullname
from senaite.core.workflow import getTransitionDate
from senaite.core.workflow import getTransitionUsers
    ...
    UIDReferenceField(
        ...
        widget=ReferenceWidget(
            ...
            helper_js=("bika_widgets/referencewidget.js",
                       "++resource++senaite.core.js/contact.js"),
...
class AnalysisRequest(BaseFolder):
    ...
    def _getCatalogTool(self):
        from senaite.core.catalog import getCatalog
