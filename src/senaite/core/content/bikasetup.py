...
from senaite.core.browser.widgets import DurationWidget
from senaite.core.browser.widgets import RecordsWidget
from senaite.core.browser.widgets import RejectionSetupWidget
from senaite.core.config import ARIMPORT_OPTIONS
from senaite.core.config import ATTACHMENT_OPTIONS
from senaite.core.config import CURRENCIES
from senaite.core.config import WEEKDAYS
from senaite.core.config import DECIMAL_MARKS
from senaite.core.config import MULTI_VERIFICATION_TYPE
from senaite.core.config import PROJECTNAME
from senaite.core.config import SCINOTATION_OPTIONS
from senaite.core.config import WORKSHEET_LAYOUT_OPTIONS
from senaite.core.content.bikaschema import BikaFolderSchema
from senaite.core.interfaces import IBikaSetup
from senaite.core.interfaces import IHaveNoBreadCrumbs
from senaite.core.locales import COUNTRIES
from senaite.core.numbergenerator import INumberGenerator
from senaite.core.vocabularies import getStickerTemplates as _getStickerTemplates
