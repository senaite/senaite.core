...
from senaite.core.browser.widgets import ARTemplateAnalysesWidget
from senaite.core.browser.widgets import ARTemplatePartitionsWidget
...
from senaite.core.interfaces import IARTemplate, IDeactivable
