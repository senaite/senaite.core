...
from senaite.core.browser.widgets import SampleTypeStickersWidget
from senaite.core.browser.widgets.referencewidget import ReferenceWidget as brw
from senaite.core.config import PROJECTNAME
from senaite.core.content.bikaschema import BikaSchema
from senaite.core.interfaces import ISampleType, IDeactivable
from senaite.core.vocabularies import getStickerTemplates
...
class SampleType(BaseContent, HistoryAwareMixin):
    ...
    def SamplePointsVocabulary(self):
        from senaite.core.content.samplepoint import SamplePoints
    ...
    def SampleMatricesVocabulary(self):
        from senaite.core.content.samplematrix import SampleMatrices
        return SampleMatrices(self, allow_blank=True)

    def ContainerTypesVocabulary(self):
        from senaite.core.content.containertype import ContainerTypes
