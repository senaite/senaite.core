...
from senaite.core.browser.fields import CoordinateField
from senaite.core.browser.fields import DurationField
from senaite.core.browser.widgets import CoordinateWidget
from senaite.core.browser.widgets import DurationWidget
from senaite.core.browser.widgets.referencewidget import \
...
class SamplePoint(BaseContent, HistoryAwareMixin):
    ...
    def SampleTypesVocabulary(self):
        from senaite.core.content.sampletype import SampleTypes
