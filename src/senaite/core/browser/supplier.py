...
from senaite.core.browser.referencesample import ReferenceSamplesView
from senaite.core.controlpanel.bika_instruments import InstrumentsView
...
class ContactsView(BikaListingView):
    ...
    def __init__(self, context, request):
        ...
        self.icon = "{}/{}".format(
            self.portal_url,
            "/++resource++senaite.core.images/contact_big.png"
        )
