...
from senaite.core.api.analysis import get_formatted_interval
from senaite.core.api.analysis import is_out_of_range
...
from senaite.core.interfaces import IFieldIcons
...
from senaite.core.utils import check_permission
from senaite.core.utils import formatDecimalMark
from senaite.core.utils import format_supsub
from senaite.core.utils import getUsers
from senaite.core.utils import get_image
from senaite.core.utils import get_link
from senaite.core.utils import t
from senaite.core.utils.analysis import format_uncertainty
    ...
    def _folder_item_attachments(self, obj, item):
        ...
        for attachment in attachments:
            ...
            img = '<img class="deleteAttachmentButton"' \
                  ' attachment_uid="{}" src="{}"/>'
            img = img.format(uid, '++resource++senaite.core.images/delete.png')
