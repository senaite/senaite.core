...
from senaite.core.browser.analysisrequest import AnalysisRequestAddView as _ARAV
from senaite.core.browser.analysisrequest import AnalysisRequestsView as _ARV
    ...
    def __init__(self, context, request):
        ...
        self.review_states = [
           ...
           {'id': 'sample_received',
            ...
            {'id': 'assigned',
             'title': "<img title='%s'\
                       src='%s/++resource++senaite.core.images/assigned.png'/>" % (
            ...
            {'id': 'unassigned',
             'title': "<img title='%s'\
                       src='%s/++resource++senaite.core.images/unassigned.png'/>" % (
