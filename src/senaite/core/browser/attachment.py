...
from senaite.core.config import ATTACHMENT_REPORT_OPTIONS
from senaite.core.decorators import returns_json
from senaite.core.permissions import AddAttachment
...
class AttachmentsView(BrowserView):
    ...
    def action_add(self):
        ...
        Code taken from senaite.core.content.addARAttachment.
        """
    ...
    def get_attachments(self):
        ...
        Original code taken from senaite.core.analysisrequest.view
        """
