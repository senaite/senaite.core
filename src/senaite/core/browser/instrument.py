...
from senaite.core.browser.analyses import AnalysesView
from senaite.core.browser.bika_listing import BikaListingView
from senaite.core.browser.chart.analyses import EvolutionChart
from senaite.core.browser.resultsimport.autoimportlogs import AutoImportLogsView
from senaite.core.browser.viewlets import InstrumentQCFailuresViewlet  # noqa
from senaite.core.catalog.analysis_catalog import CATALOG_ANALYSIS_LISTING
from senaite.core.content.instrumentmaintenancetask import \
    InstrumentMaintenanceTaskStatuses as mstatus
from senaite.core.utils import get_image, get_link, t
...
class InstrumentMaintenanceView(BikaListingView):
    ...
    def __init__(self, context, request):
        ...
        self.icon = "{}/{}".format(
            self.portal_url,
            "++resource++senaite.core.images/instrumentmaintenance_big.png"
        )
...
class InstrumentCalibrationsView(BikaListingView):
    ...
    def __init__(self, context, request):
        ...
        self.icon = "{}/{}".format(
            self.portal_url,
            "++resource++senaite.core.images/instrumentcalibration_big.png"
        )
        self.context_actions = {
            _("Add"): {
...
class InstrumentValidationsView(BikaListingView):
    ...
    def __init__(self, context, request):
        ...
        self.icon = "{}/{}".format(
            self.portal_url,
            "++resource++senaite.core.images/instrumentvalidation_big.png"
        )
        self.context_actions = {
            _("Add"): {
...
class InstrumentScheduleView(BikaListingView):
    ...
    def __init__(self, context, request):
        ...
        self.icon = "{}/{}".format(
            self.portal_url,
            "++resource++senaite.core.images/instrumentschedule_big.png"
        )
        self.context_actions = {
            _("Add"): {
...
class InstrumentReferenceAnalysesViewView(BrowserView):
    ...
    def __init__(self, context, request):
        ...
        self.icon = "{}/{}".format(
            self.portal_url,
            "++resource++senaite.core.images/referencesample_big.png"
        )
...
class InstrumentCertificationsView(BikaListingView):
    ...
    def __init__(self, context, request, **kwargs):
        ...
        self.icon = "{}/{}".format(
            self.portal_url,
            "++resource++senaite.core.images/instrumentcertification_big.png"
        )
        self.context_actions = {
            _("Add"): {
