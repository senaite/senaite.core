...
from senaite.core.browser.reports.selection_macros import SelectionMacrosView
from senaite.core.utils import createPdf
from senaite.core.utils import getUsers, logged_in_client
from senaite.core.utils import to_unicode as _u
from senaite.core.utils import to_utf8 as _c
from senaite.core.interfaces import IProductivityReport
from senaite.core.interfaces import IAdministrationReport
from senaite.core.catalog.report_catalog import CATALOG_REPORT_LISTING
...
class ProductivityView(BrowserView):
    ...
    def __call__(self):
        ...
        self.icon = self.portal_url + "/++resource++senaite.core.images/report_big.png"
