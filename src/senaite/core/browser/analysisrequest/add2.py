...
from senaite.core import POINTS_OF_CAPTURE
...
from senaite.core.interfaces import IGetDefaultFieldValueARAddHook
from senaite.core.utils import tmpID
from senaite.core.utils.analysisrequest import create_analysisrequest as crar
...
class AnalysisRequestAddView(BrowserView):
    ...
    def __call__(self):
        ...
        self.icon = self.portal_url + \
            "/++resource++senaite.core.images/sample_big.png"
