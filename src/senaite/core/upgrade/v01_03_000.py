...
from senaite.core.catalog.analysis_catalog import CATALOG_ANALYSIS_LISTING
from senaite.core.catalog.analysisrequest_catalog import \
    CATALOG_ANALYSIS_REQUEST_LISTING
from senaite.core.catalog.worksheet_catalog import CATALOG_WORKSHEET_LISTING
...
from senaite.core.interfaces import IReferenceAnalysis
from senaite.core.interfaces.analysis import IRequestAnalysis
from senaite.core.permissions import TransitionVerify
from senaite.core.setuphandlers import hide_navbar_items
from senaite.core.upgrade import upgradestep
from senaite.core.upgrade.utils import UpgradeUtils
from senaite.core.workflow import ActionHandlerPool, getAllowedTransitions
from senaite.core.workflow import changeWorkflowState
from senaite.core.workflow import doActionFor as do_action_for
from senaite.core.workflow import isTransitionAllowed
from senaite.core.workflow.analysis.events import reindex_request
from senaite.core.workflow.analysis.events import remove_analysis_from_worksheet
...
JAVASCRIPTS_TO_REMOVE = [
    "++resource++senaite.core.js/seniate.core.sample.js",
    "++resource++senaite.core.js/seniate.core.samples.js",
    "++resource++senaite.core.js/seniate.core.samples.print.js",
    "++resource++senaite.core.js/seniate.core.utils.calcs.js",
    "++resource++senaite.core.js/seniate.core.analysisrequest.publish.js",
]

CSS_TO_REMOVE = [
    "bika_invoice.css",
    "++resource++senaite.core.css/hide_contentmenu.css",
    "++resource++senaite.core.css/hide_editable_border.css",
    "print.css",
]
...
def remove_bika_listing_resources(portal):
    ...
    REMOVE_JS = [
        "++resource++senaite.core.js/seniate.core.bikalisting.js",
        "++resource++senaite.core.js/seniate.core.bikalistingfilterbar.js",
    ]
