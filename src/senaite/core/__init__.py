...
allow_module("senaite.core")
allow_module("senaite.core.config")
allow_module("senaite.core.permissions")
allow_module("senaite.core.workflow")
allow_module("senaite.core.utils")
allow_module("json")
...
from senaite.core.config import *  # noqa
from senaite.core.permissions import *  # noqa
from senaite.core.validators import *  # noqa
