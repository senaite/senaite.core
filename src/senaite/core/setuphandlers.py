...
from senaite.core.catalog import getCatalogDefinitions
from senaite.core.catalog import setup_catalogs
from senaite.core.catalog.catalog_utilities import addZCTextIndex
