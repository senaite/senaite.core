...
# When the module gets initialized (bika.lims.__init__), the function
# initialize will look through these Add permissions attributes when
# registering types and will automatically associate them with their types.
