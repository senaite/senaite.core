...
from senaite.core.interfaces import IDetachedPartition
from senaite.core.interfaces import IReceived
from senaite.core.interfaces import IVerified
from senaite.core.utils import changeWorkflowState
from senaite.core.utils.analysisrequest import create_retest
from senaite.core.workflow import get_prev_status_from_history
...
from senaite.core.workflow.analysisrequest import do_action_to_ancestors
from senaite.core.workflow.analysisrequest import do_action_to_descendants
