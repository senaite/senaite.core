...
function BikaListingTableView() {
    ...
    that.load = function() {
        ...
        // SEEMS THIS IS NOT LONGER USED --->
        // TODO: Remove if not used
        // range specification links
        $(".specification").click(function(event){
            console.warn("Please, uncomment this js: 'bika.lims.bikalisting.BikaListingTableView#L315");
            window.bika.lims.log("Please, uncomment this js: 'bika.lims.bikalisting.BikaListingTableView#L315");
