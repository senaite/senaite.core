...
function AnalysisRequestAddByCol() {
	...
	that.load = function () {
		...
		// mostly these are used to set the state variable generically.
		checkbox_change()     // does not apply to service checkboxes
		...
		template_selected()
		service_checkbox_selected()   // this includes the select-all checkboxes
