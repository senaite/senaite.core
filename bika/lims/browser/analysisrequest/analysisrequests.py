...
class AnalysisRequestsView(BikaListingView):
    ...
    def folderitems(self, full_objects=False, classic=False):
        ...
        # This is a tweak to force folderitems to be called with classic=False!
        # Note that the signature of BikaListingView is with classic=True
    ...
    def folderitem(self, obj, item, index):
        ...
        return BikaListingView.folderitem(self, obj, item, index)
