...
schema = BikaSchema.copy() + Schema((
    ...
    RecordsField('Partitions',
        ...
        widget=ARTemplatePartitionsWidget(
            label = "Sample Partitions",
            description = "Configure the sample partitions and preservations " + \
    ...
    ReferenceField('AnalysisProfile',
        ...
        widget=ReferenceWidget(
            ...
            description = "The Analysis Profile selection for this template",
            visible={'edit': 'visible', 'view': 'visible', 'add': 'visible',
                     'secondary': 'invisible'},
            catalog_name='bika_setup_catalog',
            base_query={'inactive_state': 'active'},
    ...
    RecordsField('Analyses',
        ...
        widget = ARTemplateAnalysesWidget(
            label = "Analyses",
            description = "Select analyses to include in this template",
        )
    ),
),
)
