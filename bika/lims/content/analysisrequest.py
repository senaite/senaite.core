...
schema = BikaSchema.copy() + Schema((
    ...
    ReferenceField(
        ...
        widget=ReferenceWidget(
            label = "Sample",
            description = "Select a sample to create a secondary AR",
            size=20,
            render_own_label=True,
            visible={'edit': 'visible',
                     'view': 'visible',
    ...
    ReferenceField(
        ...
        widget=ReferenceWidget(
            label = "Sample Type",
            description = "Create a new sample of this type",
            size=20,
            render_own_label=True,
            visible={'edit': 'visible',
                     'view': 'visible',
    ...
    ReferenceField(
        ...
        widget=ReferenceWidget(
            ...
            description = "Choose default AR specification values",
            size=20,
            render_own_label=True,
            visible={'edit': 'visible',
                     'view': 'visible',
    ...
    ReferenceField(
        ...
        widget=ReferenceWidget(
            label = "Publication Specification",
            description = "Set the specification to be used before publishing an AR.",
            size=20,
            render_own_label=True,
            visible={'edit': 'visible',
                     'view': 'visible',
    ...
    ReferenceField(
        ...
        widget=ReferenceWidget(
            label = "Sample Point",
            description = "Location where sample was taken",
            size=20,
            render_own_label=True,
            visible={'edit': 'visible',
                     'view': 'visible',
    ...
    ReferenceField(
        ...
        widget=ReferenceWidget(
            ...
            description = "Default container for new sample partitions",
            size=20,
            render_own_label=True,
            visible={'edit': 'visible',
                     'view': 'visible',
