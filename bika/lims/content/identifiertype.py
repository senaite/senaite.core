...
from Products.Archetypes.Widget import MultiSelectionWidget, PicklistWidget
...
class IdentifierTypeAttributesField(RecordsField):
    ...
    _properties.update({
        'type': 'IdentifierTypeAttributesField',
...
Attributes = IdentifierTypeAttributesField(
    ...
    widget=BikaRecordsWidget(
        ...
        description=_("Each item identified with this IdentifierType can "
                      "contain additional information.  The allowed attributes "
