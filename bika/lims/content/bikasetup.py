...
schema = BikaFolderSchema.copy() + Schema((
    ...
    RecordsField(
        ...
        required=0,
        fixedsize=True,
        subfields=('Type', 'UIFormat', 'PythonFormat'),
        default=[{'Type': 'date_format_long', 'PythonFormat': '%Y-%m-%d %H:%M',
        ...
        subfield_labels={'Type': _('Type'),
                         'UIFormat': _('JS Format for Users'),
                         'PythonFormat': _('Python format to parse')},
        subfield_readonly={'Type': True,
                           'UIFormat': False,
                           'PythonFormat': False},
        widget=RecordsWidget(
