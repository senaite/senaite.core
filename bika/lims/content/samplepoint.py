...
schema = BikaSchema.copy() + Schema((
    CoordinateField('Latitude',
        ...
        widget=CoordinateWidget(
            label = "Latitude",
            description = "Enter the Sample Point's latitude in degrees 0-90, minutes 0-59, seconds 0-59 and N/S indicator",
        ),
    ),
    CoordinateField('Longitude',
        ...
        widget=CoordinateWidget(
            label = "Longitude",
            description = "Enter the Sample Point's longitude in degrees 0-180, minutes 0-59, seconds 0-59 and E/W indicator",
        ),
    ),
    StringField('Elevation',
        ...
        widget=StringWidget(
            label = "Elevation",
            description = "The height or depth at which the sample has to be taken",
        ),
    ),
    DurationField('SamplingFrequency',
        ...
        widget=DurationWidget(
            ...
            description = "If a sample is taken periodically at this sample point, enter frequency here, e.g. weekly",
        ),
    ),
    ReferenceField('SampleTypes',
        ...
        widget = ReferenceWidget(
            checkbox_bound = 0,
            label = "Sample Types",
            description = "The list of sample types that can be collected " + \
    ...
    BooleanField('Composite',
        ...
        widget=BooleanWidget(
            label = "Composite",
            description = "Check this box if the samples taken at this point are 'composite' " + \
