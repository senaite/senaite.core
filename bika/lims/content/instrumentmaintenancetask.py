...
schema = BikaSchema.copy() + Schema((
    ...
    DateTimeField('DownFrom',
        ...
        widget = DateTimeWidget(
            label = "From",
            description = "Date from which the instrument is under maintenance",
            show_hm = True,
        ),
    ),
    ...
    StringField('Maintainer',
        widget = StringWidget(
            label = "Maintainer",
            description = "The analyst or agent responsible of the maintenance",
        )
    ),
    ...
    TextField('Considerations',
        ...
        widget = TextAreaWidget(
            ...
            description = "Remarks to take into account for maintenance process",
        ),
    ),
    ...
    TextField('WorkPerformed',
        ...
        widget = TextAreaWidget(
            ...
            description = "Description of the actions made during the maintenance process",
        ),
    ),
    ...
    BooleanField('Closed',
        ...
        widget = BooleanWidget(
            label = "Closed",
            description = "Set the maintenance task as closed."
        ),
    ),
))
