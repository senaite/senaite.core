...
class Tests(unittest.TestCase):
    ...
    def test_calc(self):
        ...
        self.portal.portal_workflow.doActionFor(client_1.ar_1, 'receive')
        ...
        request['results'] = json.dumps({client_1.ar_1.titration.UID():'0'})
        request['uid'] = client_1.ar_1.titration.UID()
        request['field'] = 'TV'
        request['value'] = '10'
        ret = json.loads(AJAXCalculateAnalysisEntry(client_1.ar_1.titration, request)())
