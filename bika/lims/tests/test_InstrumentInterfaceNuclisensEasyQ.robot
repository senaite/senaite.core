...
*** Variables ***
${input_identifier} = nuclisens_easyq
${ASId} = EASYQ
${ASTitle} = EasyQ HIV-1 v2.0
${ClientSampleId} = 374-3629G
...
easyQ XLSX file
    ...
    Import Instrument File     Nuclisens EasyQ  ${PATH_TO_TEST}/files/nuclisens.xlsx  ${input_identifier}
...
Import Instrument File
    ...
    Element Should Contain      ${input_identifier}_format  XLSX
