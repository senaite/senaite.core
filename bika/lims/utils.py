...
ModuleSecurityInfo('bika.lims.utils').declarePublic('sendmail')
...
ModuleSecurityInfo('bika.lims.utils').declarePublic('printfile')
...
ModuleSecurityInfo('bika.lims.utils').declarePublic('encode_header')
...
ModuleSecurityInfo('bika.lims.utils').declarePublic('sortable_title')
...
ModuleSecurityInfo('bika.lims.utils').declarePublic('generateUniqueId')
