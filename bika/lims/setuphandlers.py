...
# action.permissions = (ManageBika,)
    ...
    def setupCatalogs(self, portal):
        ...
        addIndex(bc, 'Identifiers', 'ZCTextIndex', zc_extras)
        ...
        at.setCatalogsByType('Manufacturer', ['bika_setup_catalog'])
        ...
        at.setCatalogsByType('Supplier', ['bika_setup_catalog'])
        ...
        addIndex(bsc, 'Identifiers', 'ZCTextIndex', zc_extras)
