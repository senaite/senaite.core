...
##                action.permissions = (ManageBika,)
    ...
    def setupCatalogs(self, portal):
        ...
        bsc.addIndex('sortable_description', 'FieldIndex', ('description'))
        bsc.addIndex('sortable_title', 'FieldIndex', ('sortable_title'))
        bsc.addIndex('getBlank', 'FieldIndex', ('getBlank'))
        bsc.addIndex('getBrand', 'FieldIndex', ('getBrand'))
        bsc.addIndex('getBusinessPhone', 'FieldIndex', ('getBusinessPhone'))
        bsc.addIndex('getCalculation', 'FieldIndex', ('getCalculationName'))
        bsc.addIndex('getCalibrationExpiryDate', 'FieldIndex', ('getCalibrationExpiryDate'))
        bsc.addIndex('getCanonicalPath', 'ExtendedPathIndex', ('getCanonicalPath'))
        bsc.addIndex('getCategory', 'FieldIndex', ('getCategoryName'))
        bsc.addIndex('getClientUID', 'FieldIndex', ('getClientUID'))
        bsc.addIndex('getDepartment', 'FieldIndex', ('getDepartmentName'))
        bsc.addIndex('getDuplicateVariation', 'FieldIndex', ('getDuplicateVariation'))
        bsc.addIndex('getEmailAddress', 'FieldIndex', ('getEmailAddress'))
        bsc.addIndex('getFax', 'FieldIndex', ('getFax'))
        bsc.addIndex('getFormula', 'FieldIndex', ('getFormula'))
        bsc.addIndex('getFullname', 'FieldIndex', ('getFullname'))
        bsc.addIndex('getHazardous', 'FieldIndex', ('getHazardous'))
        bsc.addIndex('getInstrument', 'FieldIndex', ('getInstrumentName'))
        bsc.addIndex('getKeyword', 'FieldIndex', ('getKeyword'))
        bsc.addIndex('getManager', 'FieldIndex', ('getManagerName'))
        bsc.addIndex('getManagerPhone', 'FieldIndex', ('getManagerNamePhone'))
        bsc.addIndex('getManagerEmail', 'FieldIndex', ('getManagerNameEmail'))
        bsc.addIndex('getMaxTimeAllowed', 'FieldIndex', ('getMaxTimeAllowed'))
        bsc.addIndex('getMobilePhone', 'FieldIndex', ('getMobilePhone'))
        bsc.addIndex('getModel', 'FieldIndex', ('getModel'))
        bsc.addIndex('getName', 'FieldIndex', ('getName'))
        bsc.addIndex('getPhone', 'FieldIndex', ('getPhone'))
        bsc.addIndex('getPrice', 'FieldIndex', ('getPrice'))
        bsc.addIndex('getProfileKey', 'FieldIndex', ('getProfileKey'))
        bsc.addIndex('getRetentionPeriod', 'FieldIndex', ('getRetentionPeriod'))
        bsc.addIndex('getSamplePoint', 'FieldIndex', ('getSamplePointName'))
        bsc.addIndex('getSampleType', 'FieldIndex', ('getSampleTypeName'))
        bsc.addIndex('getService', 'FieldIndex', ('getServiceName'))
        bsc.addIndex('getTotalPrice', 'FieldIndex', ('getTotalPrice'))
        bsc.addIndex('getType', 'FieldIndex', ('getType'))
        bsc.addIndex('getUnit', 'FieldIndex', ('getUnit'))
        bsc.addIndex('getVATAmount', 'FieldIndex', ('getVATAmount'))
        bsc.addIndex('getVolume', 'FieldIndex', ('getVolume'))
