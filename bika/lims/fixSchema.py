...
ModuleSecurityInfo('bika.lims.fixSchema').declarePublic('fixStandards')
def fixStandards (self):
    import traceback
    from Globals import package_home
    from bika.lims.config import *
    from bika.lims.configlets import bika_configlets
    from StringIO import StringIO
    from bika.lims.StandardSample import schema as ss_schema
